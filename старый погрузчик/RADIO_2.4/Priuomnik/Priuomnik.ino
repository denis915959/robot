...
RF24           radio(8, 10);                              // Создаём объект radio   для работы с библиотекой RF24, указывая номера выводов nRF24L01+ (CE, CSN)
...
void setup(){
    ...
    //myservo.attach(4);
   // pinMode(3, OUTPUT); 
    Serial.begin(9600);// Подключаем объект myservo к 4 выводу Arduino
