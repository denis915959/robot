...
class Search_Width:
    def __init__(self, m, lm393):
        ...
        self.const_after_barrier = 25 # 25
        self.tcrt5000 = 18
    ...
    def obiezd_left(self):
        ...
        if(left_koridor[1] >= 35):
            ...
            time.sleep(0.5)
            self.rotate_left_kompass(140) # 90
            time.sleep(0.5)
            ...
            if(dist > self.const_distance_correct_final):
                while((dist > self.const_distance_correct_final)and(count<const_count)):
