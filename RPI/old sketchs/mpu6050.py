...
def gyro(): #gyroskop
    ...
    dt = 0.01  # Time interval between readings (in seconds)
    theta_x = 0
    theta_y = 0
    theta_z = 0
    for i in range(100):
    ...
    # Display the angle of rotation in degrees
    print("X: {:.2f} deg, Y: {:.2f} deg, Z: {:.2f} deg".format(theta_x, theta_y, theta_z))
    time.sleep(1)
    #print "X="+str(Gx)
