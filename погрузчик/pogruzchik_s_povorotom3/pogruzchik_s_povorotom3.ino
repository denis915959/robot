...
if ( irrecv.decode( &results )) { // если данные пришли
    ...
    //sklad=170;
        break; 
    /*case 0xFFA857://это 0xFFA857, повернуть влево и взять ящик с первого этажа
     rotate_v=sklad;
    analogWrite(6, 0);
    analogWrite(11, 0);
    delay(d);
    ...
    /*digitalWrite(35, HIGH);
    digitalWrite(36, LOW);//типа продолжаем движение немного вверх
    delay(2000);*/
    povorot_platformy();
    /*digitalWrite(35, LOW);
    digitalWrite(36, LOW);//типа продолжаем движение немного вверх
    ...
    //sklad=170;
        break;
    /*case 0xF076C13B://это 0xFFE01F, повернуть влево и взять ящик со второго этажа
    rotate_v=sklad;
    analogWrite(6, 0);
    analogWrite(11, 0);
    delay(d);
    ...
    //sklad=170;
    break;   
    /*case 0xE318261B://это 0x00FFA25D, повернуть вправо и взять ящик с первого этажа
    rotate_v=sklad;
    analogWrite(6, 0);
    analogWrite(11, 0);
    delay(d);
    ...
    //sklad=170;
    break;       
    /*case 0x808B0C15://это 0xFFA995, повенуть вправо и взять ящик со 2 этажа
    rotate_v=sklad;
    analogWrite(6, 0);
    analogWrite(11, 0);
    delay(d);
...
c=1;
    ...
    /*case 0xFEE265://это 0xFEE265, поворот вправо
    servo1.write(rotate_v);
    analogWrite(6, 0);
    analogWrite(11, 0);
    delay(d);
